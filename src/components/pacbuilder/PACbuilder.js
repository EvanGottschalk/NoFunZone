...
import PAC_list_file from "../../pacs/pac_list";

import './pacbuilder.css'
...
function handleFieldChange(event) {
  console.log(event.target.className, "Field: ", event.target.value);
}
...
return (
  <div className='pacbuilder'>
    <div className='pacbuilderBoxTitle'>
      <span className='pacbuilderBoxTitle'>Point-and-Click Buidlr</span>
    </div>
      ...
      <div className='pacbuilderCenter'>
        <div className='birthInfoForm' id='birthInfoForm'>
          <div className='birthdayInputContainer' id='birthdayInputContainer'>
            <p className='birthdayTitle' id='birthdayTitle'>Adventure</p>                  
              ...
              <input className='birthDayEntry' id='birthDayEntry' placeholder="Day" type="number" onChange={handleFieldChange} required min="1" max="31" minLength="1" maxLength="2"/>
              <input className='birthYearEntry' id='birthYearEntry' placeholder="Year" type="number" onChange={handleFieldChange} required min="0" max="2022" minLength="1" maxLength="4"/>
          </div>
          <div className='birthTimeInputContainer' id='birthTimeInputContainer'>
            ...
            <br></br>
              <input className="birthTimeUnknown" id="birthTimeUnknown" type="checkbox" onChange={handleFieldChange} />
                <label className="timeUnknownLabel" id="timeUnknownLabel">Don't Know</label>
              <br></br>
              <select className='birthHourSelect' id='birthHourSelect' onChange={handleFieldChange}>
              ...
              <input className='birthMinuteEntry' id='birthMinuteEntry' placeholder="00" type="number" onChange={handleFieldChange} required min="0" max="59" minLength="1" maxLength="2"/>
              <select className='birthAMPMSelect' id='birthAMPMSelect' onChange={handleFieldChange}>
          ...
          <div className='birthLocationInputContainer' id='birthLocationInputContainer'>
            ...
            <br></br>
              <input className="birthLocationUnknown" id="birthLocationUnknown" type="checkbox" onChange={handleFieldChange} />
                <label className="locationUnknownLabel" id="locationUnknownLabel">Don't Know</label>
              <br></br>
              <input placeholder="Country" list="countryList" className='birthCountrySelect' id='birthCountrySelect' onChange={handleFieldChange}/>
                <datalist id="countryList"></datalist>
              <input placeholder="State" list="stateList" disabled="{true}" className='birthStateSelect' id='birthStateSelect' onChange={handleFieldChange}/>
                <datalist id="stateList"></datalist>
              <input placeholder="City" list="cityList" disabled="{true}" className='birthCitySelect' id='birthCitySelect' onChange={handleFieldChange}/>
